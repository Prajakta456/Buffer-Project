	    ...
	    int choice;
	              ...
	              if(counter<4)                     
	               {  int choice1;
	                  ...
	                  System.out.println("5.View the customers according to their priority in a tour package");
	                  ...
	                  switch(choice1)
	                  {
	                    ...
	                    case 5: //ALLOTMENT SECTION
	   	                      do
		                       {
		                 
		                         System.out.println("\nEnter the tour ID of the package whose customers you want to allocate:");
		                          int tourID=sc.nextInt();
		                          System.out.println("Customers served in this priority order");
		             	          int countt=0;
		                         for (int i=0;i<tours.size();i++) 
		                         {
		                	 
		                	        if(tourID==tours.get(i).tourid)
		                	        {
		                		       countt=1;
		                 ...
		                 if(countt==0)
		                 {
		                	 System.out.println("Tour id not found,Cannot show its customers");
		                 }        
	                          
		                 System.out.println("\nDo you want to allot another tour package customers?");
		                 choiceToallot=sc.nextInt();
		                 }while(choiceToallot==1);    
